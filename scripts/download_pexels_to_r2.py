...
MAX_TOTAL_BYTES = 10_000_000_000  # 10 GB  (R2 Free Tier limit — cap guards against over-run)
...
SEARCH_QUERIES = [
    # --- Sports (original) ---
    ("basketball dribbling",    30, 2),
    ("soccer match",            30, 2),
    ("tennis player",           30, 2),
    ("running athlete sprint",  30, 2),
    ("swimming competition",    30, 1),
    ("volleyball",              30, 1),
    ("skateboarding tricks",    30, 1),
    ("boxing training",         30, 1),
    ("cycling race",            30, 1),
    ("gym workout",             30, 1),
    ("football touchdown",      30, 1),
    ("golf swing",              30, 1),
    ("baseball pitch",          30, 1),
    ("martial arts",            30, 1),
    ("surfing wave",            30, 1),
    ("rock climbing",           30, 1),
    ("parkour",                 30, 1),
    ("dance performance",       30, 1),
    ("yoga exercise",           30, 1),
    ("aerial sports",           30, 1),
    # --- Nature & outdoors ---
    ("ocean waves",             30, 1),
    ("waterfall forest",        30, 1),
    ("mountain landscape",      30, 1),
    ("sunset timelapse",        30, 1),
    ("wildlife animals",        30, 1),
    ("drone aerial nature",     30, 1),
    ("rain storm lightning",    30, 1),
    ("snow winter",             30, 1),
    ("desert sand",             30, 1),
    ("birds flying",            30, 1),
    # --- City & urban life ---
    ("city traffic timelapse",  30, 1),
    ("people walking street",   30, 1),
    ("night city lights",       30, 1),
    ("busy market crowd",       30, 1),
    ("subway train commute",    30, 1),
    ("construction building",   30, 1),
    ("cafe coffee shop",        30, 1),
    ("rooftop skyline",         30, 1),
    # --- Technology & work ---
    ("coding programmer laptop",30, 1),
    ("drone flight fpv",        30, 1),
    ("robot automation factory",30, 1),
    ("3d printing",             30, 1),
    ("podcast recording studio",30, 1),
    ("photography camera",      30, 1),
    # --- Food & lifestyle ---
    ("cooking chef kitchen",    30, 1),
    ("coffee latte art",        30, 1),
    ("food market ingredients", 30, 1),
    ("travel adventure",        30, 1),
    ("family outdoor picnic",   30, 1),
    # --- Office & work ---
    ("office meeting business team",     30, 1),
    ("people working desk laptop",       30, 1),
    ("corporate presentation boardroom", 30, 1),
    ("remote work home office",          30, 1),
    ("business professionals handshake", 30, 1),
    ("coworkers whiteboard collaboration",30, 1),
    ("call center customer service",     30, 1),
    ("startup modern workspace",         30, 1),
]
