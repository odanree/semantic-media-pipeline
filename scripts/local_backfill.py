...
Config (top of file or via env vars):
    ...
    QDRANT_DOCKER_IP — Qdrant container IP on prod Docker bridge (172.18.0.4)
...
SSH_HOST       = os.getenv("SSH_HOST",       "65.108.243.192")
SSH_USER       = os.getenv("SSH_USER",       "root")

QDRANT_DOCKER_IP   = os.getenv("QDRANT_DOCKER_IP", "172.18.0.4")
