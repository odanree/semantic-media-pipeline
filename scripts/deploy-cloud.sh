...
DATABASE_PASSWORD=REDACTED_DB_PASSWORD
DATABASE_URL=postgresql://lumen_user:REDACTED_DB_PASSWORD@lumen-postgres:5432/lumen
DATABASE_ASYNC_URL=postgresql+asyncpg://lumen_user:REDACTED_DB_PASSWORD@lumen-postgres:5432/lumen
...
# Storage: Cloudflare R2
STORAGE_BACKEND=s3
S3_ENDPOINT_URL=https://YOUR_CF_ACCOUNT_ID.r2.cloudflarestorage.com
S3_BUCKET=lumen-media-demo
S3_ACCESS_KEY=REDACTED_ACCESS_KEY
S3_SECRET_KEY=REDACTED_SECRET_KEY
S3_REGION=auto
...
NEXT_PUBLIC_API_URL=https://lumen.example.com/api
...
echo ""
echo " Next steps:"
echo "  1. Point DNS: lumen.example.com → $(curl -s ifconfig.me) (A record in Cloudflare)"
echo "  2. Wait ~60s for SSL cert to provision"
echo "  3. Trigger ingest from R2:"
echo ""
echo "     curl -X POST https://lumen.example.com/api/ingest \\"
echo "       -H 'Content-Type: application/json' \\"
echo "       -d '{\"media_root\": \"\"}'"
echo ""
echo "  4. Monitor: https://lumen.example.com"
